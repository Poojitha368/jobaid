...
def create_app():
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = f'mysql+pymysql://poojitha:p@ssw0rd@ls-8351950865b689bfff6492a24882a37e8a8e80df.cgd4aj6sswr0.us-east-1.rds.amazonaws.com/{DB_NAME}'
    db.init_app(app)
